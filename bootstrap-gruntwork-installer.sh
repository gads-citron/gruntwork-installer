...
function print_usage {
  ...
  echo "    curl -Ls https://raw.githubusercontent.com/gads-citron/gruntwork-installer/v0.0.38/bootstrap-gruntwork-installer.sh | bash /dev/stdin --version v0.0.38"
}
...
scripts manageable. Many of the modules in Script Modules (https://github.com/gads-citron/script-modules) need not
